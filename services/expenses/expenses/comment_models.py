...
class ExpenseModeratorComment(models.Model):
    expense = models.ForeignKey("Expense", on_delete=models.CASCADE, related_name="moderator_comments")
...
class ExpenseCommentEdit(models.Model):
    comment = models.ForeignKey(ExpenseModeratorComment, on_delete=models.CASCADE, related_name="edits")
